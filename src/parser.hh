...
#line 130 "parser.hh" // lalr1.cc:372
  ...
  public:
    ...
    union union_type
    {
      ...
      // param
      char dummy8[sizeof(Param*)];

      // param_list
      char dummy9[sizeof(ParamList*)];

      // statement_seq
      char dummy10[sizeof(StatSeq*)];
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 445,     ///< Last index in yytable_.
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 67: // param_list
        value.copy< ParamList* > (other.value);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const Param* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ParamList* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
...
#line 2099 "parser.hh" // lalr1.cc:372
