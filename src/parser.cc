...
#line 113 "parser.yy" // lalr1.cc:847
    {
      ...
      yylhs.value.as< FunctionDeclaration* > () = new FunctionDeclaration(yystack_[7].value.as< TypeId* > (), yystack_[6].value.as< Identifier* > (), yystack_[4].value.as< ParamList* > (), yystack_[1].value.as< StatSeq* > ()); }
...
#line 121 "parser.yy" // lalr1.cc:847
    {
      yylhs.value.as< ParamList* > () = new ParamList();
      yylhs.value.as< ParamList* > ()->push_back(yystack_[0].value.as< Param* > ()); }
...
#line 125 "parser.yy" // lalr1.cc:847
    {
      std::swap(yylhs.value.as< ParamList* > (), yystack_[2].value.as< ParamList* > ());
      yylhs.value.as< ParamList* > ()->push_back(yystack_[0].value.as< Param* > ()); }
...
#line 131 "parser.yy" // lalr1.cc:847
    {
      yylhs.value.as< Param* > () = new Param(yystack_[1].value.as< TypeId* > (), yystack_[0].value.as< Identifier* > ()); }
