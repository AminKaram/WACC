...
#line 406 "parser.yy" // lalr1.cc:847
    { Number *res  = new Number(yystack_[1].value.as< int > () * yystack_[0].value.as< int > ());
       res->type = new IntTypeId();
       yylhs.value.as< Expression * > () = res; }
#line 1407 "parser.cc" // lalr1.cc:847
    break;

  case 85:
#line 412 "parser.yy" // lalr1.cc:847
    { yylhs.value.as< int > () = 1; }
#line 1413 "parser.cc" // lalr1.cc:847
    break;

  case 86:
#line 414 "parser.yy" // lalr1.cc:847
    { yylhs.value.as< int > () = 1; }
#line 1419 "parser.cc" // lalr1.cc:847
    break;
...
#line 1427 "parser.cc" // lalr1.cc:847
  ...
  case 88:
#line 422 "parser.yy" // lalr1.cc:847
    { Boolean *res = new Boolean(false);
      res->type = new BoolTypeId();
      yylhs.value.as< Expression * > () = res; }
#line 1435 "parser.cc" // lalr1.cc:847
    break;

  case 89:
#line 428 "parser.yy" // lalr1.cc:847
...
#line 434 "parser.yy" // lalr1.cc:847
    { String *res = new String(yystack_[0].value.as< std::string > ());
      ...
      yylhs.value.as< Expression * > () =res; }
#line 1451 "parser.cc" // lalr1.cc:847
    break;
...
#line 458 "parser.yy" // lalr1.cc:847
    { Null *res = new Null(); 
      res->type = new NullId();
      yylhs.value.as< Expression * > () = res; }
#line 1489 "parser.cc" // lalr1.cc:847
    break;


#line 1493 "parser.cc" // lalr1.cc:847
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
     ...
     385,   390,   395,   399,   405,   412,   413,   417,   421,   427,
     433,   439,   444,   447,   451,   457
  };
...
#line 2045 "parser.cc" // lalr1.cc:1155
#line 462 "parser.yy" // lalr1.cc:1156
