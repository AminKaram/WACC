...
%token        ASSIGN LESSEQUALS LESS GREATEREQUALS GREATER EQUALS BANG  
%token        NOTEQUALS PLUS MINUS STAR SLASH MODULO LOGAND LOGOR

%token        LPAREN RPAREN LSQUARE RSQUARE SEMICOLON COMMA ERROR

%token        PRINT PRINTLN READ NEWPAIR FST SND LEN ORD CHR

%token <sVal> IDENTIFIER STRINGLIT
...
void MC::MC_Parser::error(const std:string &message) {
  std::cerr << "Error: " << message << std::endl;

/* Include acces to scanner.yylex */
